...
- **Chapter 3: Chapter 3 — Domain Research: The Chapter Before the Chapter.** *One LLM gives you an answer. Three give you a map of what is settled, what is contested, and what nobody noticed.* Why three models and not one? Why not five? The case for three is empirical, methodological, and practical. Each frontier...
- **Chapter 4: Chapter 4 — Tic TOC: Generating Your TIKTOC.md.** *What you produce in two hours determines what two months of drafting produces.* The intake phase is four commands — `/i1` through `/i4` — and roughly forty-five minutes of session time when done well. The output is a confirmed Book Concept Summary:...
- **Chapter 5: Chapter 5 — Book Scaffold: `new_book.py`.** *Thirty seconds of typing makes the structural commitment that the rest of the book will either keep or betray.* Before the audiences, the command itself. Two arguments. That is the entire interface. `--tiktoc` points to the TIKTOC.md file from Chapter 4. The...
- **Chapter 6: Chapter 6 — Research Pass: Pantry Population.** *The pantry is not a draft and it is not a citation list. It is the only thing standing between Cowork and an authoritative-sounding lie.* The Chapter Research Gatherer is a Cowork prompt, not a separate piece of software. You give it...
- **Chapter 7: Chapter 7 — Chapter Writing: The Cowork Draft Run.** *A `log.csv` of fourteen green rows looks like a finished book. The first page of any of those chapters tells the truth.* Before the five failure modes, a brief orientation on what the Chapter Writer actually is, because "Cowork" has been doing...
- **Chapter 8: Chapter 8 — The Human Rewrite: The Seam.** *The pipeline cannot enforce this gate. The author either does this work or the book is a Cowork dump with figures.* Both versions open the same chapter. Both are 75 words. One is the Cowork draft. The other is the author's rewrite....
- **Chapter 9: Chapter 9 — Finishing Pass and Figures.** *Where the book becomes visible — and the visual fluency trap arrives on schedule.* Before the three operations, a note on tooling. CAJAL's SVG generator and the PNG converter at `SCRIPTS/svg-to-png.mjs` are Node.js programs. You need Node 18 or higher. If you...
- **Chapter 10: Chapter 10 — Enrichment for AI.** *The fluency trap, one more time — this time inside the textbook that warned you about it.* The test is a single question: > *Could this exercise appear in a different field's textbook unchanged? If yes, it fails.* The "different field" is...
