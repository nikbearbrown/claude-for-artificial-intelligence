# Appendix A — The Fundamental Themes

## Frictional · Phase Gates · Humans + AI

---

*This appendix is the theoretical frame the twelve diagnostic chapters sit inside. The chapters refer to it; the chapters do not require it. If you stop reading at Chapter 12, the book still works — you have the twenty-four diagnostic questions and the checklist that runs them.*

*The appendix is here for the reader who wants to know **why** the diagnostic moves in the chapters land where they do. The short answer: every diagnostic question in this book is a phase-gate question, and every fix is a labor separation between what AI does well (Tier 1) and what only a human can do (Tiers 4–7). The chapters are the practitioner's version. This appendix is the framework.*

*It is also the bridge to the broader series this book belongs to — Frictional, Irreducibly Human, Brutalist, and Boondoggling — for the reader who wants to follow the argument upstream. Every chapter closes with a short Tier-connection note. Those notes point here.*
